...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/dardcor/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/dardcor...\n")
...
console.log("Fetching npm all-time downloads for dardcor-ai...\n")
const npmDownloads = await fetchNpmDownloads("dardcor-ai")
