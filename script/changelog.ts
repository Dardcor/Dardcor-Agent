...
Generates UPCOMING_CHANGELOG.md by running the dardcor changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for dardcor run (default: low)
      --quiet            Suppress dardcor command output unless it fails
