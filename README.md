...
dardcor is also available as a desktop application. Download directly from the [releases page](https://dardcor-code.vercel.app/) or [dardcor.ai/download](https://dardcor-code.vercel.app/).
...
1. `$dardcor_INSTALL_DIR` - Custom installation directory
2. `$XDG_BIN_DIR` - XDG Base Directory Specification compliant path
3. `$HOME/bin` - Standard user binary directory (if it exists or can be created)
4. `$HOME/.dardcor/bin` - Default fallback
...
dardcor includes two built-in agents you can switch between with the `Tab` key.
...
Learn more about [agents](https://dardcor-code.vercel.app/).

### Documentation

For more info on how to configure dardcor, [**head over to our docs**](https://dardcor-code.vercel.app/).

### Contributing

If you're interested in contributing to dardcor, please read our [contributing docs](./CONTRIBUTING.md) before submitting a pull request.

### Building on dardcor

If you are working on a project that's related to dardcor and is using "dardcor" as part of its name, for example "dardcor-dashboard" or "dardcor-mobile", please add a note to your README to clarify that it is not built by the dardcor team and is not affiliated with us in any way.

---

**Join our community** [Discord](https://dardcor-code.vercel.app/) | [X.com](https://dardcor-code.vercel.app/)
