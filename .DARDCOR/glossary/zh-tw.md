...
- PR #13942: https://github.com/anomalyco/dardcor/pull/13942

## Do Not Translate (Locale Additions)

- `dardcor` (preserve casing in prose; keep `dardcor` only when it is part of commands, package names, paths, or code)
- `opencode Zen`
- `dardcor CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `dardcor` in prose when referring to the product name; use `dardcor`
