...
- PR #15835: https://github.com/anomalyco/dardcor/pull/15835

## Do Not Translate (Locale Additions)

- `dardcor` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `dardcor` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `dardcor` in prose, `dardcor` only for exact technical identifiers
...
- Avoid changing `dardcor` to `dardcor` inside commands, URLs, package names, or code literals
