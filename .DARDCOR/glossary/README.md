...
Use this folder for locale-specific translation guidance that supplements `.dardcor/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/dardcor/pull/12345

## Do Not Translate (Locale Additions)

- `dardcor` (preserve casing)
