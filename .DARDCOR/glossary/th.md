...
- PR #10809: https://github.com/anomalyco/dardcor/pull/10809
- PR #11496: https://github.com/anomalyco/dardcor/pull/11496

## Do Not Translate (Locale Additions)

- `dardcor` (preserve casing in prose; keep `dardcor` only in commands, package names, paths, or code)
- `dardcor CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
