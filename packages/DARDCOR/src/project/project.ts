...
import { ProjectDirectoryTable, ProjectTable } from "@dardcor-ai/core/project/sql"
import { ProjectDirectories } from "@dardcor-ai/core/project/directories"
...
import { which } from "@dardcor-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@dardcor/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.dardcor_FAKE_VCS)
