...
>()("@dardcor/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@dardcor/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.dardcor_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.dardcor_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-dardcor-directory"] || process.cwd()
}
