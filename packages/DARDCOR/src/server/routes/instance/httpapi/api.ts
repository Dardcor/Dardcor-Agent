...
import { makeApi } from "@dardcor-ai/protocol/api"
import { LocationMiddleware } from "@dardcor-ai/server/location"
import { SessionLocationMiddleware } from "@dardcor-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("dardcor-root")
...
export const InstanceHttpApi = HttpApi.make("dardcor-instance")
...
export const dardcorHttpApi = HttpApi.make("dardcor")
