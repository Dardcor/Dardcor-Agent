...
import { EventSequenceTable, EventTable } from "@dardcor-ai/core/event/sql"
...
import { WorkspaceEvent } from "@dardcor-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@dardcor/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        dardcor_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        dardcor_WORKSPACE_ID: config.id,
        dardcor_EXPERIMENTAL_WORKSPACES: "true",
