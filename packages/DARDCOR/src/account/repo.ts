...
import { AccountStateTable, AccountTable } from "@dardcor-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@dardcor/AccountRepo") {}
