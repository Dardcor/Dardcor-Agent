...
import { path } from "@dardcor-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@dardcor-ai/core/project"
...
import { WorktreeEvent } from "@dardcor-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@dardcor/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `dardcor/${name}`
