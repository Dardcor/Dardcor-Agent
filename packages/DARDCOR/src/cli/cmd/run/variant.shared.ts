...
//
// The saved variant persists across sessions in ~/.local/state/dardcor/model.json
...
class Service extends Context.Service<Service, VariantService>()("@dardcor/RunVariant") {}
