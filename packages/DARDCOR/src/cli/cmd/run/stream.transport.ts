...
import type { Event, GlobalEvent, dardcorClient } from "@dardcor-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@dardcor/RunStreamTransport") {}
