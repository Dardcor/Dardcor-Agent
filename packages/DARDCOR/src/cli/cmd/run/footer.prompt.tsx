...
import { normalizePromptContent } from "@dardcor-ai/tui/editor"
...
import { dardcor_BASE_MODE, useBindings } from "@dardcor-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close dardcor" } satisfies SlashOption,
    ]
