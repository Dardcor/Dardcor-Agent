...
import { openEditor } from "@dardcor-ai/tui/editor"
import { registerdardcorKeymap } from "@dardcor-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerdardcorKeymap(keymap, renderer, input.tuiConfig)
