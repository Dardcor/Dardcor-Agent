...
export class Service extends Context.Service<Service, Interface>()("@dardcor/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __dardcor_PHOTON_WASM_PATH?: string }).__dardcor_PHOTON_WASM_PATH =
