...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@dardcor/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@dardcor/ACPDirectory") {}
