...
import type { AssistantMessage as dardcorAssistantMessage, Message } from "@dardcor-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@dardcor-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<dardcorAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<dardcorAssistantMessage, "role"> &
  Partial<Pick<dardcorAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@dardcor/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@dardcor/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@dardcor/ACPUsage") {}
