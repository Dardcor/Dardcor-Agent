 ...
 *   "@dardcor/ServerAuthConfig",
 *   {
 *     password: Config.string("dardcor_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("dardcor_SERVER_USERNAME").pipe(Config.withDefault("dardcor")),
 *   },
 * ) {}
 *
