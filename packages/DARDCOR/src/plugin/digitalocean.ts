import type { Hooks, PluginInput } from "@dardcor-ai/plugin"
import type { Model } from "@dardcor-ai/sdk/v2"
import { InstallationVersion } from "@dardcor-ai/core/installation/version"
import { OauthCallbackPage } from "@dardcor-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. dardcor will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
