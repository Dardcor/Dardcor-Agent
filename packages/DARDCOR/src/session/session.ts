...
import { Slug } from "@dardcor-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@dardcor-ai/llm"
...
import { locationServiceMapLayer } from "@dardcor-ai/core/location-services"
...
import { PartTable, SessionTable } from "@dardcor-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@dardcor-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".dardcor", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@dardcor/Session") {}
