import type { JsonSchema, LLMRequest, ProviderMetadata } from "@dardcor-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@dardcor-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @dardcor-ai/llm request objects from dardcor's session/AI SDK-shaped data.
  return LLM.request({
