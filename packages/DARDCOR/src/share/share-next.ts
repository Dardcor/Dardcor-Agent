...
import type * as SDK from "@dardcor-ai/sdk/v2"
...
import { SessionShareTable } from "@dardcor-ai/core/share/sql"
...
const disabled = process.env["dardcor_DISABLE_SHARE"] === "true" || process.env["dardcor_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@dardcor/ShareNext") {}
