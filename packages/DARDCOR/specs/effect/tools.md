...
Practical reference for the current tool-migration state in `packages/dardcor`.
...
Tool tests should use the existing Effect helpers in `packages/dardcor/test/lib/effect.ts`:
