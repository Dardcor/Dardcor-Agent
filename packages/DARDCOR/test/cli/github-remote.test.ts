...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/dardcor.git")).toEqual({ owner: "sst", repo: "dardcor" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/dardcor")).toEqual({ owner: "sst", repo: "dardcor" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/dardcor.git")).toEqual({ owner: "sst", repo: "dardcor" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/dardcor")).toEqual({ owner: "sst", repo: "dardcor" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/dardcor.git")).toEqual({ owner: "sst", repo: "dardcor" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/dardcor")).toEqual({ owner: "sst", repo: "dardcor" })
})
