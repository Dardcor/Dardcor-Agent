...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders dardcor_CALLER", () => {
    process.env["dardcor_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode dardcor_CALLER", () => {
    process.env["dardcor_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown dardcor_CALLER", () => {
    process.env["dardcor_CALLER"] = "unknown"
