...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips dardcor-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-dardcor-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-dardcor-directory")).toBeNull()
      expect(result.get("x-dardcor-workspace")).toBeNull()
