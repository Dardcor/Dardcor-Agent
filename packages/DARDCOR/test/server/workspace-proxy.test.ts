...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips dardcor-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-dardcor-directory"]).toBeUndefined()
      expect(forwarded["x-dardcor-workspace"]).toBeUndefined()
