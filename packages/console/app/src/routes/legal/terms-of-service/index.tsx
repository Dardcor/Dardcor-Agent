...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>dardcor | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="dardcor terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to dardcor. Please read on to learn the rules and restrictions that govern your use of
                dardcor&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("dardcor," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://dardcor-code.vercel.app//legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-dardcor">What is dardcor?</h2>
              <p>
                dardcor is an AI-powered coding agent that helps you write, understand, and modify code using large
                ...
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, dardcor enables you to
              ...
              <p>
                ...
                our site located at dardcor.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                dardcor takes the privacy of its users very seriously. For the current dardcor Privacy Policy, please
                click here{" "}
                <a href="https://dardcor-code.vercel.app//legal/privacy-policy">https://dardcor-code.vercel.app//legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using dardcor?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by dardcor;
                </li>
                <li>
              ...
              <p>
                If you use dardcor with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                dardcor. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                dardcor has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-dardcor-ever-change-the-services">Will dardcor ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://opencode.ai</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://dardcor-code.vercel.app//auth">https://dardcor-code.vercel.app//auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://dardcor-code.vercel.app//legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                dardcor is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. dardcor has the sole right to decide whether you are
              ...
              <p>
                dardcor and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (dardcor and all such
                parties together, the "dardcor Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the dardcor Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The dardcor Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY dardcor (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                dardcor PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO dardcor IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the dardcor Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without dardcor's prior written
              ...
              <p>
                ...
                disputes and claims with dardcor and limits the manner in which you can seek relief from dardcor. Both
                you and dardcor acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, dardcor's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. dardcor will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. dardcor will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or dardcor may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND dardcor WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and dardcor are instead choosing to have claims and disputes resolved by
                ...
                you and dardcor over whether to vacate or enforce an arbitration award, YOU AND dardcor WAIVE ALL
              ...
              <p>
                ...
                dardcor is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or dardcor to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and dardcor agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the dardcor may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and dardcor agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and dardcor, and
                ...
                are not an employee, agent, partner, or joint venture of dardcor, and you do not have any authority of
                any kind to bind dardcor in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and dardcor
