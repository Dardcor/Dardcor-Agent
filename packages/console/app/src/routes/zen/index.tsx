...
import compareVideo from "../../asset/lander/dardcor-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/dardcor-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="dardcor:auth" content={loggedin() ? "true" : "false"} />
