...
import desktopAppIcon from "../../asset/lander/dardcor-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://dardcor-code.vercel.app//install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>dardcor.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g dardcor-ai")}>
                <code>
                  npm i -g <strong>dardcor-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g dardcor-ai")}>
                <code>
                  bun add -g <strong>dardcor-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/dardcor")}>
                <code>
                  brew install <strong>anomalyco/tap/dardcor</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S dardcor")}>
                <code>
                  paru -S <strong>dardcor</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask dardcor-desktop")}>
                <code>
                  brew install --cask <strong>dardcor-desktop</strong>
                </code>
                <CopyStatus />
              </button>
