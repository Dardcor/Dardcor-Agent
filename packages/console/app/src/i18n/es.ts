...
export const dict = {
  ...
  "notFound.title": "No encontrado | dardcor",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "dardcor logo claro",
  "notFound.logoDarkAlt": "dardcor logo oscuro",
  ...
  "app.meta.description": "dardcor - El agente de codificación de código abierto.",

  "home.title": "dardcor | El agente de codificación IA de código abierto",

  "temp.title": "dardcor | Agente de codificación IA creado para la terminal",
  ...
  "temp.feature.zen.afterLink": "proporcionada por dardcor",
  ...
  "temp.screenshot.caption": "dardcor TUI con el tema tokyonight",
  "temp.screenshot.alt": "dardcor TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de dardcor claro",
  "temp.logoDarkAlt": "logo de dardcor oscuro",
  ...
  "home.what.title": "¿Qué es dardcor?",
  "home.what.body":
    "dardcor es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, dardcor es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "dardcor no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es dardcor?",
  "home.faq.a1":
    "dardcor es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso dardcor?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar dardcor?",
  "home.faq.a3.p1":
    "No necesariamente, dardcor viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, dardcor también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con dardcor?",
  "home.faq.a4.p1":
    "Sí, dardcor soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar dardcor en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! dardcor ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta dardcor?",
  "home.faq.a6":
    "dardcor es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es dardcor de código abierto?",
  "home.faq.a8.p1": "Sí, dardcor es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que dardcor ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  ...
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que dardcor ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es opencode Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de dardcor.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá dardcor negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, dardcor añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con dardcor, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de dardcor.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con dardcor, puedes usar Zen con cualquier agente.",
  ...
  "go.testimonials.handle": "@dardcor",
  ...
  "go.problem.body":
    "Nos enfocamos en llevar la experiencia de dardcor a tantas personas como sea posible. opencode Go es una suscripción de bajo coste: $5 el primer mes, luego 10 $/mes. Proporciona límites generosos y acceso fiable a los modelos de código abierto más capaces.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go comienza en $5 el primer mes, luego 10 $/mes. Puedes usarlo con dardcor o cualquier agente.",
  ...
  "black.meta.title": "dardcor Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de dardcor Black.",
  ...
  "black.title": "dardcor Black | Precios",
  ...
  "black.workspace.title": "dardcor Black | Seleccionar Espacio de Trabajo",
  "black.workspace.selectPlan": "Selecciona un espacio de trabajo para este plan",
  "black.workspace.name": "Espacio de trabajo {{n}}",
  "black.subscribe.title": "Suscribirse a dardcor Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de dardcor Black",
  "black.subscribe.success.subscriptionPlan": "Plan de suscripción",
  "black.subscribe.success.planName": "dardcor Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con dardcor cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona dardcor",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia dardcor y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de dardcor.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de dardcor Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a dardcor Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan dardcor Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan dardcor Black de ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "opencode Go" como proveedor en tu configuración de dardcor para usar los modelos Go.',
  ...
  "workspace.lite.black.message":
    "Actualmente estás suscrito a dardcor Black o estás en la lista de espera. Por favor, cancela la suscripción primero si deseas cambiar a Go.",
  ...
  "download.title": "dardcor | Descargar",
  "download.meta.description": "Descarga dardcor para macOS, Windows y Linux",
  "download.hero.title": "Descargar dardcor",
  "download.hero.subtitle": "Disponible en Beta para macOS, Windows y Linux",
  "download.hero.button": "Descargar para {{os}}",
  "download.section.terminal": "dardcor Terminal",
  "download.section.desktop": "dardcor Desktop (Beta)",
  "download.section.extensions": "Extensiones dardcor",
  "download.section.integrations": "Integraciones dardcor",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar dardcor a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", dardcor funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "dardcor es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque dardcor funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en dardcor.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "dardcor | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a dardcor para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "dardcor opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es dardcor Enterprise?",
  "enterprise.faq.a1":
    "dardcor Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con dardcor Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. dardcor por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con dardcor Enterprise?",
  "enterprise.faq.a4":
    "Sí. dardcor no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "dardcor | Marca",
  "brand.meta.description": "Guías de marca de dardcor",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca dardcor.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "dardcor | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de dardcor",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para dardcor",
