...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | dardcor",
  "notFound.heading": "404 - Side ikke funnet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentasjon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "dardcor logo lys",
  "notFound.logoDarkAlt": "dardcor logo mørk",
  ...
  "app.meta.description": "dardcor - Den åpne kildekode kodingsagenten.",

  "home.title": "dardcor | Den åpne kildekode AI-kodingsagenten",

  "temp.title": "dardcor | AI-kodingsagent bygget for terminalen",
  ...
  "temp.feature.zen.afterLink": "levert av dardcor",
  ...
  "temp.screenshot.caption": "dardcor TUI med tokyonight-tema",
  "temp.screenshot.alt": "dardcor TUI med tokyonight-tema",
  "temp.logoLightAlt": "dardcor logo lys",
  "temp.logoDarkAlt": "dardcor logo mørk",
  ...
  "home.what.title": "Hva er dardcor?",
  "home.what.body": "dardcor er en åpen kildekode-agent som hjelper deg å skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes dardcor av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "dardcor lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er dardcor?",
  "home.faq.a1":
    "dardcor er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg dardcor?",
  "home.faq.a2.before": "Den enkleste måten å komme i gang på er å lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for å bruke dardcor?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. dardcor kommer med et sett gratis modeller du kan bruke uten å opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved å opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men dardcor fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med dardcor?",
  "home.faq.a4.p1":
    "Ja, dardcor støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke dardcor i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! dardcor er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster dardcor?",
  "home.faq.a6":
    "dardcor er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er dardcor åpen kildekode?",
  "home.faq.a8.p1": "Ja, dardcor er fullt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et håndplukket sett med AI-modeller som dardcor har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet på tvers av leverandører; bruk validerte modeller som fungerer.",
  ...
  "zen.hero.body":
    "Zen gir deg tilgang til et kuratert sett med AI-modeller som dardcor har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet; bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er opencode Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodeagenter, laget av teamet bak dardcor.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandørene direkte til deg. Jo mer Zen brukes, desto bedre priser kan dardcor forhandle og gi videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For å dekke kostnader legger dardcor til bare et lite betalingsbehandlingsgebyr på $1.23 per $20 saldo-påfyll.",
  ...
  "zen.faq.a8":
    "Selv om Zen fungerer veldig bra med dardcor, kan du bruke Zen med hvilken som helst agent. Følg oppsettinstruksjonene i din foretrukne kodeagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare dardcor-brukere.",
  ...
  "zen.how.body": "Selv om vi foreslår at du bruker Zen med dardcor, kan du bruke Zen med hvilken som helst agent.",
  ...
  "go.problem.body":
    "Vi fokuserer på å bringe dardcor-opplevelsen til så mange som mulig. opencode Go er et rimelig abonnement: $5 for den første måneden, deretter $10/måned. Det gir sjenerøse grenser og pålitelig tilgang til de mest kapable åpen kildekode-modellene.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go starter på $5 for den første måneden, deretter $10/måned. Du kan bruke det med dardcor eller hvilken som helst agent.",
  ...
  "black.meta.title": "dardcor Black | Få tilgang til verdens beste kodemodeller",
  "black.meta.description": "Få tilgang til Claude, GPT, Gemini og mer med dardcor Black-abonnementer.",
  "black.hero.title": "Få tilgang til verdens beste kodemodeller",
  "black.hero.subtitle": "Inkludert Claude, GPT, Gemini og mer",
  "black.title": "dardcor Black | Priser",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for dardcor Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med dardcor når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg dardcor",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start dardcor og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til dardcor-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en dardcor Gateway API-nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på dardcor Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du står på venteliste for dardcor Black-planen til ${{plan}} per måned.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på dardcor Black-planen til ${{plan}} per måned.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Velg "opencode Go" som leverandør i dardcor-konfigurasjonen din for å bruke Go-modeller.',
  ...
  "workspace.lite.black.message":
    "Du abonnerer for øyeblikket på dardcor Black eller står på venteliste. Vennligst avslutt abonnementet først hvis du vil bytte til Go.",
  ...
  "download.title": "dardcor | Last ned",
  "download.meta.description": "Last ned dardcor for macOS, Windows og Linux",
  "download.hero.title": "Last ned dardcor",
  ...
  "download.section.extensions": "dardcor Extensions",
  "download.section.integrations": "dardcor Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble dardcor til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer dardcor med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "dardcor er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om dardcor fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i dardcor.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "dardcor | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt dardcor for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "dardcor opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er dardcor Enterprise?",
  "enterprise.faq.a1":
    "dardcor Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med dardcor Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. dardcor lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med dardcor Enterprise?",
  "enterprise.faq.a4":
    "Ja. dardcor lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "dardcor | Merkevare",
  "brand.meta.description": "dardcor retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med dardcor-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "dardcor | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for dardcor",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for dardcor",
