...
export const TypeId: TypeId = "~@dardcor-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@dardcor-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@dardcor-ai/effect-sqlite-node/NodeSqliteClient")
