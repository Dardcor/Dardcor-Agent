...
const releaseId = process.env.dardcor_RELEASE
if (!releaseId) throw new Error("dardcor_RELEASE is required")

const version = process.env.dardcor_VERSION
if (!version) throw new Error("dardcor_VERSION is required")
...
const macxTarGz = "dardcor-desktop-mac-x64.app.tar.gz"
const macaTarGz = "dardcor-desktop-mac-arm64.app.tar.gz"
