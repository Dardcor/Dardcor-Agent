export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de dardcor",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de dardcor. ¿Quieres instalarla y reiniciar?",
