...
import { Icondardcor } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "dardcor/session/message-v2"
import type { Message } from "dardcor/session/message"
import type { Session } from "dardcor/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.dardcor_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.dardcor_name}>
                    <Icondardcor width={16} height={16} />
                  </div>
