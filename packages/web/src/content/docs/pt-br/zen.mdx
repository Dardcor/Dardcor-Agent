---
title: Zen
description: Lista selecionada de modelos fornecidos pelo dardcor.
---
...
O opencode Zen é uma lista de modelos testados e verificados fornecidos pela equipe do dardcor.

O Zen funciona como qualquer outro provedor no dardcor. Você faz login no opencode Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o dardcor.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o dardcor.
:::
...
O opencode Zen funciona como qualquer outro provedor no dardcor.
...
O [model id](/docs/config/#models) na sua configuração do dardcor usa o formato `dardcor/<model-id>`. Por exemplo, para GPT 5.5, você usaria `dardcor/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no dardcor por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no dardcor por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- North Mini Code Free está disponível no dardcor por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no dardcor por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no dardcor por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o dardcor também.
