...
O Go funciona como qualquer outro provedor no dardcor. Você assina o opencode Go e
...
O opencode Go funciona como qualquer outro provedor no dardcor.
...
O [ID do modelo](/docs/config/#models) na sua configuração do dardcor
usa o formato `dardcor-go/<model-id>`. Por exemplo, para o Kimi K2.7 Code, você usaria
`dardcor-go/kimi-k2.7-code` na sua configuração.
...
4. Não ter **nenhuma restrição de fornecedor (lock-in)**, permitindo que você use qualquer outro provedor com o dardcor também.
