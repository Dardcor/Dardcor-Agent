---
title: TUI
description: استخدام واجهة المستخدم TUI في dardcor.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر dardcor واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل dardcor إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة dardcor في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى dardcor. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من dardcor. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `dardcor.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار dardcor بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `dardcor.default`.
