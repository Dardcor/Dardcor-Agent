---
title: Zen
description: قائمة منتقاة من النماذج يوفّرها dardcor.
---
...
opencode Zen هي قائمة بالنماذج التي اختبرها فريق dardcor وتحقّق منها.

يعمل Zen مثل أي مزوّد آخر في dardcor. تسجّل الدخول إلى opencode Zen وتحصل على
مفتاح API. استخدامه **اختياري بالكامل** ولا تحتاج إليه لاستخدام dardcor.
...
:::tip
اختبرنا مجموعة منتقاة من النماذج والمزوّدين الذين يعملون جيدا مع dardcor.
:::
...
يعمل opencode Zen مثل أي مزوّد آخر في dardcor.
...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات dardcor الصيغة `dardcor/<model-id>`. على سبيل المثال، بالنسبة إلى GPT 5.5، ستستخدم `dardcor/gpt-5.5` في إعداداتك.
...
- DeepSeek V4 Flash Free متاح على dardcor لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- MiMo-V2.5 Free متاح على dardcor لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- North Mini Code Free متاح على dardcor لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Nemotron 3 Ultra Free متاح على dardcor لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Big Pickle نموذج خفي ومتاح مجانا على dardcor لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
...
4. **عدم فرض أي ارتباط حصري** عبر تمكينك من استخدامه مع أي عامل برمجة آخر. ومع إبقاء إمكانية استخدام أي مزوّد آخر مع dardcor أيضا دائما.
