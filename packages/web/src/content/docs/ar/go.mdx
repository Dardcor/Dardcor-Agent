...
يعمل Go مثل أي مزود آخر في dardcor. تشترك في opencode Go وتحصل على مفتاح API الخاص بك. وهو **اختياري تمامًا**، ولا تحتاج إلى استخدامه لاستخدام dardcor.
...
:::tip
اختبرنا مجموعة مختارة من النماذج والمزودين الذين يعملون جيدًا مع dardcor.
:::
...
يعمل opencode Go مثل أي مزود آخر في dardcor.
...
يستخدم [model id](/docs/config/#models) في إعدادات dardcor لديك التنسيق `dardcor-go/<model-id>`. على سبيل المثال، بالنسبة إلى Kimi K2.7 Code، ستستخدم `dardcor-go/kimi-k2.7-code` في إعداداتك.
...
4. **عدم فرض قيود ارتباط** من خلال السماح لك أيضًا باستخدام أي مزود آخر مع dardcor.
