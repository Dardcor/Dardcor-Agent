...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في dardcor.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في dardcor مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.dardcor/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/dardcor/tools/`.
