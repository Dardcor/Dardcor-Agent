...
Utwórz `.dardcor/commands/test.md`:
...
Możesz zdefiniować polecenia w `dardcor.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji dardcor:
...
- Globalnie: `~/.config/dardcor/commands/`
- Na projekt: `.dardcor/commands/`
...
dardcor zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
