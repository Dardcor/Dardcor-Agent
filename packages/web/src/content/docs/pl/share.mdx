---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące dardcor.
---

Funkcja udostępniania dardcor umożliwia tworzenie publicznych linków do konwersacji dardcor, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, dardcor:
...
dardcor obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie dardcor korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `dardcor.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu dardcor w Twojej organizacji.
