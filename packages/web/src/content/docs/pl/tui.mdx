---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala dardcor.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

dardcor zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie dardcor uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI dardcor, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do dardcor. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij dardcor. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `dardcor.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo dardcor czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `dardcor.default`.
