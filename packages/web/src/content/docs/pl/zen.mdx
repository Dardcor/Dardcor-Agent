---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez dardcor.
---
...
opencode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół dardcor.

Zen działa jak każdy inny dostawca w dardcor. Logujesz się do opencode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z dardcor.
:::
...
opencode Zen działa jak każdy inny dostawca w dardcor.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji dardcor używa formatu
`dardcor/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`dardcor/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w dardcor przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w dardcor przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w dardcor przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w dardcor przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w dardcor przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w dardcor także dowolnego innego dostawcy.
