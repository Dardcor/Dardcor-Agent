---
title: Zen
description: Curated list of models provided by dardcor.
---
...
opencode Zen is a list of tested and verified models provided by the dardcor team.

Zen works like any other provider in dardcor. You login to opencode Zen and get
...
:::tip
We tested a select group of models and providers that work well with dardcor.
:::
...
opencode Zen is a free AI gateway that gives you access to these models.

---

## How it works

opencode Zen works like any other provider in dardcor.
...
The [model id](/docs/config/#models) in your dardcor config
uses the format `dardcor/<model-id>`. For example, for GPT 5.5, you would
use `dardcor/gpt-5.5` in your config.
...
- DeepSeek V4 Flash Free is available on dardcor for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on dardcor for a limited time. The team is using this time to collect feedback and improve the model.
- North Mini Code Free is available on dardcor for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on dardcor for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on dardcor for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with dardcor as well.
