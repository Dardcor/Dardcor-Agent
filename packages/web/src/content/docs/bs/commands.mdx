...
Kreiraj `.dardcor/commands/test.md`:
...
Možete dodati prilagođene komande kroz dardcor konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom dardcor [config](/docs/config):
...
- Globalno: `~/.config/dardcor/commands/`
- Po projektu: `.dardcor/commands/`
...
dardcor uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
