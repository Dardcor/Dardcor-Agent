---
title: Zen
description: Kurirana lista modela koje nudi dardcor.
---
...
opencode Zen je lista testiranih i provjerenih modela koje pruža dardcor tim.

Zen radi kao i svaki drugi provajder u dardcor. Prijavite se na opencode Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili dardcor.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s dardcor.
:::
...
opencode Zen radi kao i svaki drugi provajder u dardcor.
...
[model id](/docs/config/#models) u vašoj dardcor konfiguraciji koristi format
`dardcor/<model-id>`. Na primjer, za GPT 5.5 u konfiguraciji biste
koristili `dardcor/gpt-5.5`.
...
- DeepSeek V4 Flash Free je dostupan na dardcor ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na dardcor ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- North Mini Code Free je dostupan na dardcor ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Ultra Free je dostupan na dardcor ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na dardcor ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u dardcor.
