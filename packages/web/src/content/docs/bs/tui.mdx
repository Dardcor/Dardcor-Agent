---
title: TUI
description: Korištenje korisničkog interfejsa dardcor terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

dardcor pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje dardcor pokreće TUI za trenutni direktorij.
...
Kada koristite dardcor TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u dardcor. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz dardcor. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `dardcor.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo dardcor čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `dardcor.default`.
