---
title: LSP serveri
description: dardcor se integriše sa vašim LSP serverima.
---

dardcor se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

dardcor dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `dardcor_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i dardcor otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj dardcor konfiguraciji.
