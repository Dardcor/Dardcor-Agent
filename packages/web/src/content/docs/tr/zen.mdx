---
title: Zen
description: dardcor tarafından sağlanan seçilmiş modeller listesi.
---
...
opencode Zen, dardcor ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, dardcor'daki diğer sağlayıcılar gibi çalışır. opencode Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve dardcor kullanmak için buna ihtiyacınız yoktur.
...
:::tip
dardcor ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
opencode Zen, dardcor'daki diğer sağlayıcılar gibi çalışır.
...
dardcor yapılandırmanızdaki [model id](/docs/config/#models) `dardcor/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `dardcor/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için dardcor'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için dardcor'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için dardcor'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için dardcor'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için dardcor'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca dardcor ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
