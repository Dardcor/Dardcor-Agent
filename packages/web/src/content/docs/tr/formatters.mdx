...
description: dardcor dile özgü biçimlendiriciler kullanır.
---

dardcor, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

dardcor, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, dardcor bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

dardcor bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri dardcor yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
