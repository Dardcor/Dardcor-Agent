---
title: Paylasim
description: dardcor konusmalarini genel baglantilarla paylasin.
---

dardcor'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda dardcor:
...
dardcor, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak dardcor manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `dardcor.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda dardcor kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
