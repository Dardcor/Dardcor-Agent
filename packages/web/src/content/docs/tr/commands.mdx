...
`.dardcor/commands/test.md` oluştur:
...
dardcor işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

dardcor [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/dardcor/commands/`
- Proje başına: `.dardcor/commands/`
...
dardcor, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
