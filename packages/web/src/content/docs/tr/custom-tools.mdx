---
title: Özel Araçlar
description: LLM'un dardcor'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. dardcor'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.dardcor/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/dardcor/tools/` içine yerleştirerek.
