...
Go funziona come qualsiasi altro provider in dardcor. Ti abboni a opencode Go e
...
opencode Go funziona come qualsiasi altro provider in dardcor.
...
Il [model id](/docs/config/#models) nella tua dardcor config
utilizza il formato `dardcor-go/<model-id>`. Ad esempio, per Kimi K2.7 Code, useresti
`dardcor-go/kimi-k2.7-code` nella tua configurazione.
...
4. Non avere **nessun lock-in**, permettendoti di utilizzare anche qualsiasi altro provider con dardcor.
