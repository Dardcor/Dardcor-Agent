...
Puoi aggiungere comandi personalizzati tramite la config di dardcor o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di dardcor:
...
- Globale: `~/.config/dardcor/commands/`
- Per progetto: `.dardcor/commands/`
...
dardcor include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
