...
Go fonctionne comme n'importe quel autre fournisseur dans dardcor. Vous vous abonnez à opencode Go et obtenez votre clé d'API. C'est **totalement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser dardcor.
...
opencode Go fonctionne comme n'importe quel autre fournisseur dans dardcor.
...
| ----------------- | ----------------- | ------------------------------------------------ | --------------------------- |
| GLM-5.2           | glm-5.2           | `https://opencode.ai/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5.1           | glm-5.1           | `https://opencode.ai/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.7 Code    | kimi-k2.7-code    | `https://opencode.ai/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.6         | kimi-k2.6         | `https://opencode.ai/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Pro   | deepseek-v4-pro   | `https://opencode.ai/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash | deepseek-v4-flash | `https://opencode.ai/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5         | mimo-v2.5         | `https://opencode.ai/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5-Pro     | mimo-v2.5-pro     | `https://opencode.ai/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiniMax M3        | minimax-m3        | `https://opencode.ai/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.7      | minimax-m2.7      | `https://opencode.ai/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.5      | minimax-m2.5      | `https://opencode.ai/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Max       | qwen3.7-max       | `https://opencode.ai/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus      | qwen3.7-plus      | `https://opencode.ai/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus      | qwen3.6-plus      | `https://opencode.ai/go/v1/messages`         | `@ai-sdk/anthropic`         |

L'[ID de modèle](/docs/config/#models) dans votre configuration dardcor utilise le format `dardcor-go/<model-id>`. Par exemple, pour Kimi K2.7 Code, vous utiliseriez `dardcor-go/kimi-k2.7-code` dans votre configuration.
...
4. N'avoir **aucun verrouillage exclusif** en vous permettant d'utiliser n'importe quel autre fournisseur avec dardcor également.
