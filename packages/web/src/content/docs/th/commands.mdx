...
สร้าง `.dardcor/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ dardcor:
...
- ระดับผู้ใช้ (Global): `~/.config/dardcor/commands/`
- ระดับโปรเจ็กต์: `.dardcor/commands/`
...
dardcor มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
