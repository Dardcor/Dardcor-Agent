...
Go ทำงานเหมือนกับผู้ให้บริการ (provider) รายอื่นๆ ใน dardcor คุณสามารถสมัครสมาชิก opencode Go และรับ API key ของคุณ บริการนี้เป็น**ทางเลือกเพิ่มเติม** และคุณไม่จำเป็นต้องใช้มันเพื่อใช้งาน dardcor
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่คัดเลือกมาเพื่อให้ทำงานร่วมกับ dardcor ได้เป็นอย่างดี
:::
...
opencode Go ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน dardcor
...
[model id](/docs/config/#models) ใน dardcor config ของคุณจะใช้รูปแบบ `dardcor-go/<model-id>` ตัวอย่างเช่น สำหรับ Kimi K2.7 Code คุณจะใช้ `dardcor-go/kimi-k2.7-code` ใน config ของคุณ
...
4. **ไม่ผูกขาดการใช้งาน (no lock-in)** โดยอนุญาตให้คุณใช้งานผู้ให้บริการรายอื่นๆ ร่วมกับ dardcor ได้เช่นกัน
