---
title: Zen
description: Kuratierte Modellliste direkt von dardcor.
---
...
opencode Zen ist eine Liste von getesteten und verifizierten Modellen, die vom dardcor-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in dardcor. Du meldest dich bei opencode Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um dardcor zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit dardcor funktionieren.
:::
...
opencode Zen funktioniert wie jeder andere Provider in dardcor.
...
Die [Model-ID](/docs/config/#models) in deiner dardcor-Konfiguration verwendet das Format `dardcor/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `dardcor/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf dardcor verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf dardcor verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf dardcor verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf dardcor verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf dardcor verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit dardcor auch jeden anderen Provider zu verwenden.
