---
title: Teilen
description: Teile dardcor-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu dardcor-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht dardcor Folgendes:
...
dardcor hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt dardcor den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`dardcor.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du dardcor in deiner Organisation einsetzt.
