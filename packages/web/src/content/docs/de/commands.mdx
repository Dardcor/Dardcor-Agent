...
Erstellen Sie `.dardcor/commands/test.md`:

```md title=".dardcor/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die dardcor-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem dardcor [config](/docs/config):

```json title="dardcor.jsonc" {4-12}
{
...
- Global: `~/.config/dardcor/commands/`
- Pro Projekt: `.dardcor/commands/`

```markdown title="~/.config/dardcor/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".dardcor/commands/component.md"
---
...
```md title=".dardcor/commands/create-file.md"
---
...
```md title=".dardcor/commands/analyze-coverage.md"
---
...
```md title=".dardcor/commands/review-changes.md"
---
...
```md title=".dardcor/commands/review-component.md"
---
...
dardcor enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
