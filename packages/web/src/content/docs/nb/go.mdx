...
Go fungerer som enhver annen leverandør i dardcor. Du abonnerer på opencode Go og
...
opencode Go fungerer som enhver annen leverandør i dardcor.
...
[Modell-ID-en](/docs/config/#models) i din dardcor-konfigurasjon
bruker formatet `dardcor-go/<model-id>`. For eksempel, for Kimi K2.7 Code, vil du
bruke `dardcor-go/kimi-k2.7-code` i konfigurasjonen din.
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med dardcor også.
