---
title: TUI
description: Bruke dardcor-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

dardcor gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre dardcor starter TUI for gjeldende katalog.
...
Når du bruker dardcor TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til dardcor. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt dardcor. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `dardcor.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge dardcor venter etter leader key. Standard er `2000`.
...
Bruk `dardcor_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `dardcor.default`.
