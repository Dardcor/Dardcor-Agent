---
title: LSP-servere
description: dardcor integreres med LSP-serverne dine.
---

dardcor kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

dardcor kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `dardcor_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og dardcor åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i dardcor-konfigurasjonen.
