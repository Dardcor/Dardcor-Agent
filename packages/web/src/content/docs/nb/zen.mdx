---
title: Zen
description: Utvalgt liste over modeller levert av dardcor.
---
...
opencode Zen er en liste over testede og verifiserte modeller levert av dardcor-teamet.

Zen fungerer som enhver annen leverandør i dardcor. Du logger inn på opencode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med dardcor.
:::
...
opencode Zen fungerer som enhver annen leverandør i dardcor.
...
[modell-id](/docs/config/#models) i dardcor-konfigurasjonen din
bruker formatet `dardcor/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `dardcor/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på dardcor i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på dardcor i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på dardcor i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på dardcor i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på dardcor i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med dardcor også.
