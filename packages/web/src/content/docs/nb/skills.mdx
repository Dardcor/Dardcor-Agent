...
Agentferdigheter lar dardcor oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
dardcor søker etter disse stedene:

- Prosjektkonfigurasjon: `.dardcor/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/dardcor/skills/<name>/SKILL.md`
...
For prosjektlokale stier går dardcor opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.dardcor/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/dardcor/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.dardcor/skills/git-release/SKILL.md` slik:
...
dardcor viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `dardcor.json`:
...
**For innebygde agenter** (i `dardcor.json`):
