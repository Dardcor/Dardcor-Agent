...
Opprett `.dardcor/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom dardcor-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i dardcor [config](/docs/config):
...
dardcor inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
