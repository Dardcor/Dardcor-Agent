...
Crear `.dardcor/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración dardcor o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su dardcor [config](/docs/config):
...
dardcor incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
