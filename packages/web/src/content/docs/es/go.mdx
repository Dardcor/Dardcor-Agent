...
Go funciona como cualquier otro proveedor en dardcor. Te suscribes a opencode Go y
...
opencode Go funciona como cualquier otro proveedor en dardcor.
...
El [ID del modelo](/docs/config/#models) en tu configuración de dardcor
usa el formato `dardcor-go/<model-id>`. Por ejemplo, para Kimi K2.7 Code, usarías
`dardcor-go/kimi-k2.7-code` en tu configuración.
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con dardcor.
