---
title: Zen
description: Udvalgt liste over modeller leveret af dardcor.
---
...
opencode Zen er en liste over testede og verificerede modeller leveret af dardcor-teamet.

Zen fungerer som enhver anden udbyder i dardcor. Du logger ind på opencode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med dardcor.
:::
...
opencode Zen fungerer som enhver anden udbyder i dardcor.
...
[model id](/docs/config/#models) i din dardcor-konfiguration
bruger formatet `dardcor/<model-id>`. For eksempel ville du for GPT 5.5
bruge `dardcor/gpt-5.5` i din konfiguration.
...
- DeepSeek V4 Flash Free er tilgængelig på dardcor i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på dardcor i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- North Mini Code Free er tilgængelig på dardcor i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på dardcor i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på dardcor i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med dardcor også.
