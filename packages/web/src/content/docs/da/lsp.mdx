---
title: LSP-servere
description: dardcor integreres med dine LSP-servere.
---

dardcor kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

dardcor leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `dardcor_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og dardcor åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din dardcor-konfiguration.
