...
Go fungerer som enhver anden udbyder i dardcor. Du abonnerer på opencode Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med dardcor.
:::
...
opencode Go fungerer som enhver anden udbyder i dardcor.
...
Dit [model id](/docs/config/#models) i din dardcor config
bruger formatet `dardcor-go/<model-id>`. For eksempel for Kimi K2.7 Code, vil du
bruge `dardcor-go/kimi-k2.7-code` i din config.
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med dardcor.
