export const dict = {
  ...
  "dialog.provider.dardcor.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.dardcor.tagline": "Надежные оптимизированные модели",
  "dialog.provider.dardcorGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от dardcor",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в dardcor.",
  ...
  "provider.connect.dardcorZen.visit.prefix": "Посетите ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в dardcor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в dardcor.",
  ...
  "dialog.plugins.empty": "Плагины настроены в dardcor.json",
  ...
  "dialog.server.description": "Переключите сервер dardcor к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingdardcor": "Проверка dardcor...",
  "wsl.onboarding.checkingdardcorIn": "Проверка dardcor в {{distro}}...",
  "wsl.onboarding.updatingdardcor": "Обновление dardcor...",
  "wsl.onboarding.updatingdardcorIn": "Обновление dardcor в {{distro}}...",
  "wsl.onboarding.updatedardcorIn": "Обновите dardcor в {{distro}}.",
  "wsl.onboarding.updatedardcor": "Обновить dardcor",
  "wsl.onboarding.dardcorReadyIn": "dardcor в {{distro}} готов к работе.",
  "wsl.onboarding.dardcorReady": "dardcor готов к работе.",
  "wsl.onboarding.installdardcorIn": "Установите dardcor в {{distro}}.",
  "wsl.onboarding.installdardcor": "Установить dardcor",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в dardcor требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "dardcor не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте dardcor.",
  ...
  "toast.update.description": "Новая версия dardcor ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде dardcor",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (dardcor.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что dardcor пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "dardcor включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер dardcor внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения dardcor",
  ...
  "settings.general.row.appearance.description": "Настройте как dardcor выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли dardcor системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление dardcor.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске dardcor",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию dardcor.",
