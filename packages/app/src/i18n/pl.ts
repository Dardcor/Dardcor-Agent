export const dict = {
  ...
  "dialog.provider.dardcor.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.dardcor.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.dardcorGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez dardcor",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w dardcor.",
  ...
  "provider.connect.dardcorZen.visit.prefix": "Odwiedź ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w dardcor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w dardcor.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w dardcor.json",
  ...
  "dialog.server.description": "Przełącz serwer dardcor, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingdardcor": "Sprawdzanie dardcor...",
  "wsl.onboarding.checkingdardcorIn": "Sprawdzanie dardcor w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingdardcor": "Aktualizowanie dardcor...",
  "wsl.onboarding.updatingdardcorIn": "Aktualizowanie dardcor w dystrybucji {{distro}}...",
  "wsl.onboarding.updatedardcorIn": "Zaktualizuj dardcor w dystrybucji {{distro}}.",
  "wsl.onboarding.updatedardcor": "Zaktualizuj dardcor",
  "wsl.onboarding.dardcorReadyIn": "dardcor jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.dardcorReady": "dardcor jest gotowy.",
  "wsl.onboarding.installdardcorIn": "Zainstaluj dardcor w dystrybucji {{distro}}.",
  "wsl.onboarding.installdardcor": "Zainstaluj dardcor",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim dardcor będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "dardcor nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz dardcor.",
  ...
  "toast.update.description": "Nowa wersja dardcor ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu dardcor",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (dardcor.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: dardcor nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "dardcor zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer dardcor wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla dardcor",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd dardcor na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy dardcor ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw dardcor.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania dardcor",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji dardcor.",
