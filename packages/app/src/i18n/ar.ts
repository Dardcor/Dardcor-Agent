export const dict = {
  ...
  "dialog.provider.dardcor.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.dardcor.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.dardcorGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من dardcor",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في dardcor.",
  ...
  "provider.connect.dardcorZen.visit.prefix": "قم بزيارة ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في dardcor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في dardcor.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في dardcor.json",
  ...
  "dialog.server.description": "تبديل خادم dardcor الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingdardcor": "جارٍ التحقق من dardcor...",
  "wsl.onboarding.checkingdardcorIn": "جارٍ التحقق من dardcor في {{distro}}...",
  "wsl.onboarding.updatingdardcor": "جارٍ تحديث dardcor...",
  "wsl.onboarding.updatingdardcorIn": "جارٍ تحديث dardcor في {{distro}}...",
  "wsl.onboarding.updatedardcorIn": "حدّث dardcor في {{distro}}.",
  "wsl.onboarding.updatedardcor": "تحديث dardcor",
  "wsl.onboarding.dardcorReadyIn": "dardcor جاهز في {{distro}}.",
  "wsl.onboarding.dardcorReady": "dardcor جاهز.",
  "wsl.onboarding.installdardcorIn": "ثبّت dardcor في {{distro}}.",
  "wsl.onboarding.installdardcor": "تثبيت dardcor",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن dardcor من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على dardcor التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح dardcor.",
  ...
  "toast.update.description": "نسخة جديدة من dardcor ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق dardcor",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (dardcor.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن dardcor لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن dardcor نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم dardcor داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ dardcor",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور dardcor على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان dardcor يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة dardcor.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل dardcor",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من dardcor.",
