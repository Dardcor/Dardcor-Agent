export const dict = {
  ...
  "dialog.provider.dardcor.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.dardcor.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.dardcorGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje dardcor",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u dardcor-u.",
  ...
  "provider.connect.dardcorZen.visit.prefix": "Posjeti ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u dardcor-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u dardcor-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u dardcor.json",
  ...
  "dialog.server.description": "Promijeni na koji se dardcor server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingdardcor": "Provjera dardcor...",
  "wsl.onboarding.checkingdardcorIn": "Provjera dardcor u distribuciji {{distro}}...",
  "wsl.onboarding.updatingdardcor": "Ažuriranje dardcor...",
  "wsl.onboarding.updatingdardcorIn": "Ažuriranje dardcor u distribuciji {{distro}}...",
  "wsl.onboarding.updatedardcorIn": "Ažuriraj dardcor u distribuciji {{distro}}.",
  "wsl.onboarding.updatedardcor": "Ažuriraj dardcor",
  "wsl.onboarding.dardcorReadyIn": "dardcor je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.dardcorReady": "dardcor je spreman.",
  "wsl.onboarding.installdardcorIn": "Instaliraj dardcor u distribuciji {{distro}}.",
  "wsl.onboarding.installdardcor": "Instaliraj dardcor",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi dardcor mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "dardcor nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori dardcor.",
  ...
  "toast.update.description": "Nova verzija dardcor-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku dardcor timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (dardcor.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: dardcor još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "dardcor uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni dardcor server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u dardcor-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako dardcor izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li dardcor prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu dardcor-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se dardcor pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju dardcor-a.",
