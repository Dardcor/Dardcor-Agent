export const dict = {
  ...
  "dialog.provider.dardcor.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.dardcor.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.dardcorGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "dardcorが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、dardcorで{{provider}}モデルを使用します。",
  ...
  "provider.connect.dardcorZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.dardcorZen.visit.prefix": " ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してdardcorで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、dardcorで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "dardcor.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するdardcorサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingdardcor": "dardcorを確認中...",
  "wsl.onboarding.checkingdardcorIn": "{{distro}}内のdardcorを確認中...",
  "wsl.onboarding.updatingdardcor": "dardcorを更新中...",
  "wsl.onboarding.updatingdardcorIn": "{{distro}}内のdardcorを更新中...",
  "wsl.onboarding.updatedardcorIn": "{{distro}}内のdardcorを更新してください。",
  "wsl.onboarding.updatedardcor": "dardcorを更新",
  "wsl.onboarding.dardcorReadyIn": "{{distro}}内のdardcorの準備ができました。",
  "wsl.onboarding.dardcorReady": "dardcorの準備ができました。",
  "wsl.onboarding.installdardcorIn": "{{distro}}にdardcorをインストールしてください。",
  "wsl.onboarding.installdardcor": "dardcorをインストール",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcorがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "dardcorでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、dardcorをもう一度開いてください。",
  ...
  "toast.update.description": "dardcorの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをdardcorチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (dardcor.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: dardcorはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "dardcorには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でdardcorサーバーを実行します。",
  ...
  "settings.general.row.language.description": "dardcorの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのdardcorの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "dardcorがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "dardcorのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "dardcor の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "dardcor は最新バージョンです。",
