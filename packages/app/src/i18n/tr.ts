...
export const dict = {
  ...
  "dialog.provider.dardcor.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.dardcor.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.dardcorGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "dardcor tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve dardcor'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.dardcorZen.visit.prefix": "",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak dardcor'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak dardcor'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler dardcor.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi dardcor sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingdardcor": "dardcor kontrol ediliyor...",
  "wsl.onboarding.checkingdardcorIn": "{{distro}} içinde dardcor kontrol ediliyor...",
  "wsl.onboarding.updatingdardcor": "dardcor güncelleniyor...",
  "wsl.onboarding.updatingdardcorIn": "{{distro}} içinde dardcor güncelleniyor...",
  "wsl.onboarding.updatedardcorIn": "{{distro}} içindeki dardcor'u güncelleyin.",
  "wsl.onboarding.updatedardcor": "dardcor'u güncelle",
  "wsl.onboarding.dardcorReadyIn": "{{distro}} içinde dardcor hazır.",
  "wsl.onboarding.dardcorReady": "dardcor hazır.",
  "wsl.onboarding.installdardcorIn": "dardcor'u {{distro}} içine kurun.",
  "wsl.onboarding.installdardcor": "dardcor'u kur",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "dardcor'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "dardcor bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından dardcor'u tekrar açın.",
  ...
  "toast.update.description": "dardcor'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı dardcor ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (dardcor.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: dardcor henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "dardcor ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "dardcor Masaüstü",
  ...
  "settings.desktop.wsl.description": "dardcor sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "dardcor'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "dardcor'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "dardcor'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "dardcor'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "dardcor başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "dardcor'un en son sürümünü kullanıyorsunuz.",
