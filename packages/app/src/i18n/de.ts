...
export const dict = {
  ...
  "dialog.provider.dardcor.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.dardcor.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.dardcorGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von dardcor",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in dardcor zu nutzen.",
  ...
  "provider.connect.dardcorZen.line1":
    "opencode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.dardcorZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.dardcorZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in dardcor zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in dardcor zu nutzen.",
  ...
  "dialog.plugins.empty": "In dardcor.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den dardcor-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.dardcor": "dardcor",
  ...
  "wsl.onboarding.checkingdardcor": "dardcor wird geprüft...",
  "wsl.onboarding.checkingdardcorIn": "dardcor in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingdardcor": "dardcor wird aktualisiert...",
  "wsl.onboarding.updatingdardcorIn": "dardcor in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updatedardcorIn": "Aktualisieren Sie dardcor in {{distro}}.",
  "wsl.onboarding.updatedardcor": "dardcor aktualisieren",
  "wsl.onboarding.dardcorReadyIn": "dardcor ist in {{distro}} bereit.",
  "wsl.onboarding.dardcorReady": "dardcor ist bereit.",
  "wsl.onboarding.installdardcorIn": "Installieren Sie dardcor in {{distro}}.",
  "wsl.onboarding.installdardcor": "dardcor installieren",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor dardcor einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "dardcor konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann dardcor erneut.",
  ...
  "toast.update.description": "Eine neue Version von dardcor ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem dardcor-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (dardcor.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: dardcor unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "dardcor enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "dardcor Desktop",
  ...
  "settings.desktop.wsl.description": "dardcor-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für dardcor ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie dardcor auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob dardcor dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von dardcor anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von dardcor automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von dardcor.",
