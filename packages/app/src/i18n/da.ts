export const dict = {
  ...
  "dialog.provider.dardcor.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.dardcor.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.dardcorGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af dardcor",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i dardcor.",
  ...
  "provider.connect.dardcorZen.visit.prefix": "Besøg ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i dardcor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i dardcor.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i dardcor.json",
  ...
  "dialog.server.description": "Skift hvilken dardcor-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingdardcor": "Tjekker dardcor...",
  "wsl.onboarding.checkingdardcorIn": "Tjekker dardcor i {{distro}}...",
  "wsl.onboarding.updatingdardcor": "Opdaterer dardcor...",
  "wsl.onboarding.updatingdardcorIn": "Opdaterer dardcor i {{distro}}...",
  "wsl.onboarding.updatedardcorIn": "Opdater dardcor i {{distro}}.",
  "wsl.onboarding.updatedardcor": "Opdater dardcor",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før dardcor kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "dardcor kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter dardcor igen.",
  ...
  "toast.update.description": "En ny version af dardcor ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til dardcor-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (dardcor.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, dardcor understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "dardcor inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør dardcor-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for dardcor",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan dardcor ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om dardcor følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan dardcor er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når dardcor starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af dardcor.",
