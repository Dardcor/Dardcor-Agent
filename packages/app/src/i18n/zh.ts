...
export const dict = {
  ...
  "dialog.provider.dardcor.note": "使用 opencode Zen 或 API 密钥连接",
  "dialog.provider.dardcor.tagline": "可靠的优化模型",
  "dialog.provider.dardcorGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "dardcor 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 dardcor 中使用 {{provider}} 模型。",
  ...
  "provider.connect.dardcorZen.line1": "opencode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.dardcorZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.dardcorZen.visit.prefix": "访问 ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 dardcor 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 dardcor 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 dardcor.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 dardcor 服务器。",
  ...
  "wsl.onboarding.checkingdardcor": "正在检查 dardcor...",
  "wsl.onboarding.checkingdardcorIn": "正在检查 {{distro}} 中的 dardcor...",
  "wsl.onboarding.updatingdardcor": "正在更新 dardcor...",
  "wsl.onboarding.updatingdardcorIn": "正在更新 {{distro}} 中的 dardcor...",
  "wsl.onboarding.updatedardcorIn": "更新 {{distro}} 中的 dardcor。",
  "wsl.onboarding.updatedardcor": "更新 dardcor",
  "wsl.onboarding.dardcorReadyIn": "{{distro}} 中的 dardcor 已就绪。",
  "wsl.onboarding.dardcorReady": "dardcor 已就绪。",
  "wsl.onboarding.installdardcorIn": "在 {{distro}} 中安装 dardcor。",
  "wsl.onboarding.installdardcor": "安装 dardcor",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "未安装 dardcor",
  ...
  "wsl.onboarding.wslNotInstalled.description": "dardcor 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "dardcor 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 dardcor。",
  ...
  "toast.update.description": "dardcor 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 dardcor 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (dardcor.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: dardcor 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "dardcor 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 dardcor 服务器。",
  ...
  "settings.general.row.language.description": "更改 dardcor 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 dardcor 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 dardcor 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 dardcor 的主题。",
  ...
  "settings.updates.row.startup.description": "在 dardcor 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 dardcor。",
