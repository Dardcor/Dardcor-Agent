...
export const dict = {
  ...
  "dialog.provider.dardcor.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.dardcor.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.dardcorGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av dardcor",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i dardcor.",
  ...
  "provider.connect.dardcorZen.visit.prefix": "Besøk ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i dardcor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i dardcor.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i dardcor.json",
  ...
  "dialog.server.description": "Bytt hvilken dardcor-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av dardcor ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til dardcor-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (dardcor.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at dardcor ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "dardcor inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør dardcor-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for dardcor",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan dardcor ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om dardcor skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan dardcor er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når dardcor starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av dardcor.",
  ...
  "wsl.onboarding.checkingdardcor": "Sjekker dardcor...",
  "wsl.onboarding.checkingdardcorIn": "Sjekker dardcor i {{distro}}...",
  "wsl.onboarding.updatingdardcor": "Oppdaterer dardcor...",
  "wsl.onboarding.updatingdardcorIn": "Oppdaterer dardcor i {{distro}}...",
  "wsl.onboarding.updatedardcorIn": "Oppdater dardcor i {{distro}}.",
  "wsl.onboarding.updatedardcor": "Oppdater dardcor",
  "wsl.onboarding.dardcorReadyIn": "dardcor er klar i {{distro}}.",
  "wsl.onboarding.dardcorReady": "dardcor er klar.",
  "wsl.onboarding.installdardcorIn": "Installer dardcor i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før dardcor kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "dardcor kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter dardcor på nytt.",
