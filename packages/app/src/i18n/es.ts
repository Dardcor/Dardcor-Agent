export const dict = {
  ...
  "dialog.provider.dardcor.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.dardcor.tagline": "Modelos optimizados y fiables",
  "dialog.provider.dardcorGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por dardcor",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en dardcor.",
  ...
  "provider.connect.dardcorZen.visit.prefix": "Visita ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en dardcor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en dardcor.",
  ...
  "dialog.plugins.empty": "Plugins configurados en dardcor.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de dardcor se conecta esta app.",
  ...
  "wsl.onboarding.checkingdardcor": "Comprobando dardcor...",
  "wsl.onboarding.checkingdardcorIn": "Comprobando dardcor en {{distro}}...",
  "wsl.onboarding.updatingdardcor": "Actualizando dardcor...",
  "wsl.onboarding.updatingdardcorIn": "Actualizando dardcor en {{distro}}...",
  "wsl.onboarding.updatedardcorIn": "Actualiza dardcor en {{distro}}.",
  "wsl.onboarding.updatedardcor": "Actualizar dardcor",
  "wsl.onboarding.dardcorReadyIn": "dardcor está listo en {{distro}}.",
  "wsl.onboarding.dardcorReady": "dardcor está listo.",
  "wsl.onboarding.installdardcorIn": "Instala dardcor en {{distro}}.",
  "wsl.onboarding.installdardcor": "Instalar dardcor",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que dardcor pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "dardcor no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir dardcor.",
  ...
  "toast.update.description": "Una nueva versión de dardcor ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de dardcor",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (dardcor.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, dardcor no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "dardcor incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor dardcor dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para dardcor",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve dardcor en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si dardcor sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de dardcor.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia dardcor",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de dardcor.",
