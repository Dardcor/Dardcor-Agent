export const dict = {
  ...
  "dialog.provider.dardcor.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.dardcor.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.dardcorGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від dardcor",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у dardcor.",
  ...
  "provider.connect.dardcorZen.visit.prefix": "Відвідайте ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у dardcor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у dardcor.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в dardcor.json",
  ...
  "dialog.server.description": "Перемкніть сервер dardcor, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingdardcor": "Перевірка dardcor...",
  "wsl.onboarding.checkingdardcorIn": "Перевірка dardcor у {{distro}}...",
  "wsl.onboarding.updatingdardcor": "Оновлення dardcor...",
  "wsl.onboarding.updatingdardcorIn": "Оновлення dardcor у {{distro}}...",
  "wsl.onboarding.updatedardcorIn": "Оновіть dardcor у {{distro}}.",
  "wsl.onboarding.updatedardcor": "Оновити dardcor",
  "wsl.onboarding.dardcorReadyIn": "dardcor готовий до роботи у {{distro}}.",
  "wsl.onboarding.dardcorReady": "dardcor готовий до роботи.",
  "wsl.onboarding.installdardcorIn": "Встановіть dardcor у {{distro}}.",
  "wsl.onboarding.installdardcor": "Встановити dardcor",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в dardcor потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "dardcor не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте dardcor.",
  ...
  "toast.update.description": "Нова версія dardcor ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді dardcor",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (dardcor.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, dardcor ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "dardcor містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер dardcor всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу dardcor",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд dardcor на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи dardcor використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему dardcor.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску dardcor",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію dardcor.",
