export const dict = {
  ...
  "dialog.provider.dardcor.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.dardcor.tagline": "Modèles optimisés et fiables",
  "dialog.provider.dardcorGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par dardcor",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans dardcor.",
  ...
  "provider.connect.dardcorZen.visit.prefix": "Visitez ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans dardcor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans dardcor.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans dardcor.json",
  ...
  "dialog.server.description": "Changez le serveur dardcor auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingdardcor": "Vérification d'dardcor...",
  "wsl.onboarding.checkingdardcorIn": "Vérification d'dardcor dans {{distro}}...",
  "wsl.onboarding.updatingdardcor": "Mise à jour d'dardcor...",
  "wsl.onboarding.updatingdardcorIn": "Mise à jour d'dardcor dans {{distro}}...",
  "wsl.onboarding.updatedardcorIn": "Mettez à jour dardcor dans {{distro}}.",
  "wsl.onboarding.updatedardcor": "Mettre à jour dardcor",
  "wsl.onboarding.dardcorReadyIn": "dardcor est prêt dans {{distro}}.",
  "wsl.onboarding.dardcorReady": "dardcor est prêt.",
  "wsl.onboarding.installdardcorIn": "Installez dardcor dans {{distro}}.",
  "wsl.onboarding.installdardcor": "Installer dardcor",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'dardcor puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "dardcor n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez dardcor.",
  ...
  "toast.update.description":
    "Une nouvelle version d'dardcor ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe dardcor",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (dardcor.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'dardcor ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "dardcor inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur dardcor dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour dardcor",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'dardcor sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si dardcor suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'dardcor.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'dardcor",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'dardcor.",
