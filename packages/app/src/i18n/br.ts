export const dict = {
  ...
  "dialog.provider.dardcor.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.dardcor.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.dardcorGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo dardcor",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no dardcor.",
  ...
  "provider.connect.dardcorZen.visit.prefix": "Visite ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no dardcor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no dardcor.",
  ...
  "dialog.plugins.empty": "Plugins configurados em dardcor.json",
  ...
  "dialog.server.description": "Trocar para qual servidor dardcor este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingdardcor": "Verificando o dardcor...",
  "wsl.onboarding.checkingdardcorIn": "Verificando o dardcor em {{distro}}...",
  "wsl.onboarding.updatingdardcor": "Atualizando o dardcor...",
  "wsl.onboarding.updatingdardcorIn": "Atualizando o dardcor em {{distro}}...",
  "wsl.onboarding.updatedardcorIn": "Atualize o dardcor em {{distro}}.",
  "wsl.onboarding.updatedardcor": "Atualizar o dardcor",
  "wsl.onboarding.dardcorReadyIn": "O dardcor está pronto em {{distro}}.",
  "wsl.onboarding.dardcorReady": "O dardcor está pronto.",
  "wsl.onboarding.installdardcorIn": "Instale o dardcor em {{distro}}.",
  "wsl.onboarding.installdardcor": "Instalar o dardcor",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o dardcor possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O dardcor não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o dardcor novamente.",
  ...
  "toast.update.description": "Uma nova versão do dardcor ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do dardcor",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (dardcor.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: dardcor ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "dardcor inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor dardcor dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do dardcor",
  ...
  "settings.general.row.appearance.description": "Personalize como o dardcor aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o dardcor segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o dardcor é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o dardcor iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do dardcor.",
