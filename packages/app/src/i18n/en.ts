export const dict = {
  ...
  "dialog.provider.dardcor.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.dardcor.tagline": "Reliable optimized models",
  "dialog.provider.dardcorGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by dardcor",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in dardcor.",
  ...
  "provider.connect.dardcorZen.visit.prefix": "Visit ",
  "provider.connect.dardcorZen.visit.link": "dardcor.ai/zen",
  "provider.connect.dardcorZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in dardcor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in dardcor.",
  ...
  "dialog.plugins.empty": "Plugins configured in dardcor.json",
  ...
  "dialog.server.description": "Switch which dardcor server this app connects to.",
  ...
  "wsl.onboarding.checkingdardcor": "Checking dardcor...",
  "wsl.onboarding.checkingdardcorIn": "Checking dardcor in {{distro}}...",
  "wsl.onboarding.updatingdardcor": "Updating dardcor...",
  "wsl.onboarding.updatingdardcorIn": "Updating dardcor in {{distro}}...",
  "wsl.onboarding.updatedardcorIn": "Update dardcor in {{distro}}.",
  "wsl.onboarding.updatedardcor": "Update dardcor",
  "wsl.onboarding.dardcorReadyIn": "dardcor is ready in {{distro}}.",
  "wsl.onboarding.dardcorReady": "dardcor is ready.",
  "wsl.onboarding.installdardcorIn": "Install dardcor in {{distro}}.",
  "wsl.onboarding.installdardcor": "Install dardcor",
  ...
  "wsl.onboarding.distroStatus.dardcorMissing": "dardcor not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before dardcor can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "dardcor could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen dardcor.",
  ...
  "toast.update.description": "A new version of dardcor ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the dardcor team",
  ...
  "error.chain.checkConfig": "Check your config (dardcor.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, dardcor does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "dardcor includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the dardcor server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for dardcor",
  ...
  "settings.general.row.appearance.description": "Customise how dardcor looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether dardcor follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how dardcor is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when dardcor launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of dardcor.",
