...
import { getFilename } from "@dardcor-ai/core/util/path"
import { Session } from "@dardcor-ai/sdk/v2/client"
...
import { toaster } from "@dardcor-ai/ui/toast"
...
import { retry } from "@dardcor-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@dardcor-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://dardcor-code.vercel.app//desktop-feedback")}
      renderPanel={() =>
