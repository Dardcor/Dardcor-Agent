...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "dardcor", key: "dialog.provider.dardcor.note" },
  { match: (id: string) => id === "dardcor-go", key: "dialog.provider.dardcorGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "dardcor" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "dardcor" || item.id === "dardcor-go"}>
