...
beforeAll(async () => {
  ...
  mock.module("@dardcor-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@dardcor-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@dardcor-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@dardcor-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
