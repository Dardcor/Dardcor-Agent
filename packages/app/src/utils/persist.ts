...
const GLOBAL_STORAGE = "dardcor.global.dat"
const WINDOW_STORAGE = "dardcor.window"
const LOCAL_PREFIX = "dardcor."
...
function workspaceStorage(dir: string) {
  ...
  return `dardcor.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `dardcor.draft.${head}.${sum}.dat`
}
