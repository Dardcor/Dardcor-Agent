...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: dardcorClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: dardcorClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: dardcorClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => dardcorClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, dardcorClient>()
