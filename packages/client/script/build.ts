...
import { compile, emitEffectImported, emitPromise, write } from "@dardcor-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "dardcorEventEncoded",
              import: 'import type { dardcorEventEncoded } from "@dardcor-ai/protocol/groups/event"',
            },
          },
        }),
