...
Schema-first LLM core for dardcor. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@dardcor-ai/llm"
import { OpenAI } from "@dardcor-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@dardcor-ai/llm/providers"
