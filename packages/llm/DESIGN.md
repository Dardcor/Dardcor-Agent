...
> current private `@dardcor-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@dardcor-ai/ai`
...
- Secondary audience: dardcor and other durable agent runtimes
...
import { LLM } from "@dardcor-ai/ai"
import { OpenAI } from "@dardcor-ai/ai/providers/openai"
...
```ts
import { Message } from "@dardcor-ai/ai"
...
import { LLM, Tool } from "@dardcor-ai/ai"
...
dardcor and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@dardcor-ai/ai/promise"
import { OpenAI } from "@dardcor-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@dardcor-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@dardcor-ai/ai/provider"
...
@dardcor-ai/ai/promise
  Promise/AsyncIterable LLM facade

@dardcor-ai/ai/schema
  serializable domain schemas

@dardcor-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@dardcor-ai/ai/providers/openai
@dardcor-ai/ai/providers/anthropic
@dardcor-ai/ai/providers/google
...
```
...
dardcor should migrate to `generateTurn` / `streamTurn`, preserving its durable
