...
import type { Definition } from "@dardcor-ai/schema/event"
...
export const dardcorEvent = event.schema
export type dardcorEvent = typeof dardcorEvent.Type
export type dardcorEventEncoded = typeof dardcorEvent.Encoded
