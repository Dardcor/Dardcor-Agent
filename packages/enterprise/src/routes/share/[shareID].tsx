import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@dardcor-ai/sdk/v2"
import { SessionTurn } from "@dardcor-ai/session-ui/session-turn"
import { SessionReview } from "@dardcor-ai/session-ui/session-review"
import { DataProvider } from "@dardcor-ai/session-ui/context"
import { FileComponentProvider } from "@dardcor-ai/ui/context/file"
import { WorkerPoolProvider } from "@dardcor-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@dardcor-ai/ui/logo"
import { IconButton } from "@dardcor-ai/ui/icon-button"
import { ProviderIcon } from "@dardcor-ai/ui/provider-icon"
import { iife } from "@dardcor-ai/core/util/iife"
import { Binary } from "@dardcor-ai/core/util/binary"
import { NamedError } from "@dardcor-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@dardcor-ai/ui/tabs"
import { MessageNav } from "@dardcor-ai/session-ui/message-nav"
import { FileSSR } from "@dardcor-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@dardcor-ai/session-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/dardcor-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | dardcor</Title>
              </Show>
              <Meta name="description" content="dardcor - The AI coding agent built for the terminal." />
                      ...
                      return (
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            <div class="">
                              <a href="https://dardcor-code.vercel.app/">
                                <Mark />
                              </a>
                            </div>
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/dardcor"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://dardcor-code.vercel.app//discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
