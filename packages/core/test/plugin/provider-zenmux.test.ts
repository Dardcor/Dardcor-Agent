...
import { ProviderPlugins } from "@dardcor-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@dardcor-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://dardcor-code.vercel.app//", "X-Title": "dardcor" })
