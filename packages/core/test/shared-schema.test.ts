...
import { ModelV2 } from "@dardcor-ai/core/model"
import { SessionV2 } from "@dardcor-ai/core/session"
import { Agent } from "@dardcor-ai/schema/agent"
import { Location } from "@dardcor-ai/schema/location"
import { Model } from "@dardcor-ai/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@dardcor-ai/schema/prompt"
import { Provider } from "@dardcor-ai/schema/provider"
import { Project } from "@dardcor-ai/schema/project"
import { ProjectDirectories } from "@dardcor-ai/schema/project-directories"
import { PermissionV1 } from "@dardcor-ai/schema/permission-v1"
import { Session } from "@dardcor-ai/schema/session"
import { SessionInput } from "@dardcor-ai/schema/session-input"
import { SessionMessage } from "@dardcor-ai/schema/session-message"
import { Workspace } from "@dardcor-ai/schema/workspace"
import { Command } from "@dardcor-ai/schema/command"
import { Connection } from "@dardcor-ai/schema/connection"
import { Credential } from "@dardcor-ai/schema/credential"
import { FileSystem } from "@dardcor-ai/schema/filesystem"
import { Integration } from "@dardcor-ai/schema/integration"
import { LLM } from "@dardcor-ai/schema/llm"
import { Permission } from "@dardcor-ai/schema/permission"
import { Plugin } from "@dardcor-ai/schema/plugin"
import { Pty } from "@dardcor-ai/schema/pty"
import { Reference } from "@dardcor-ai/schema/reference"
import { SessionTodo } from "@dardcor-ai/schema/session-todo"
import { Skill } from "@dardcor-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@dardcor-ai/schema/schema"
import { ProviderV2 } from "@dardcor-ai/core/provider"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@dardcor-ai/core/command"),
    import("@dardcor-ai/core/integration/connection"),
    import("@dardcor-ai/core/credential"),
    import("@dardcor-ai/core/filesystem"),
    import("@dardcor-ai/core/integration"),
    import("@dardcor-ai/core/location"),
    import("@dardcor-ai/llm"),
    import("@dardcor-ai/core/permission"),
    import("@dardcor-ai/core/v1/permission"),
    import("@dardcor-ai/core/project/copy"),
    import("@dardcor-ai/core/pty"),
    import("@dardcor-ai/core/project/schema"),
    import("@dardcor-ai/core/reference"),
    import("@dardcor-ai/core/session/input"),
    import("@dardcor-ai/core/session/message"),
    import("@dardcor-ai/core/session/todo"),
    import("@dardcor-ai/core/session/prompt"),
    import("@dardcor-ai/core/skill"),
    import("@dardcor-ai/core/v2-schema"),
    import("@dardcor-ai/core/schema"),
    import("@dardcor-ai/core/workspace"),
  ])
