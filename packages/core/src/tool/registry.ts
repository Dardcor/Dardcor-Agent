...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@dardcor-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@dardcor/v2/ToolRegistry") {}
