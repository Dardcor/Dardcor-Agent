...
import { Entry, FileSystem, FindInput, Match } from "@dardcor-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@dardcor-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@dardcor/v2/FileSystem") {}
