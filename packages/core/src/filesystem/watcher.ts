...
import { FileSystemWatcher } from "@dardcor-ai/schema/filesystem-watcher"
...
declare const dardcor_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof dardcor_LIBC === "undefined" ? undefined : dardcor_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@dardcor/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.dardcor_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.dardcor_EXPERIMENTAL_FILEWATCHER)) {
