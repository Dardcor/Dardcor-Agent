...
export class Service extends Context.Service<Service, Interface>()("@dardcor/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.dardcor_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
