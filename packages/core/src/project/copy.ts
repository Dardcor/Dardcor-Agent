...
import { Event } from "@dardcor-ai/schema/project-directories"
import { ProjectCopy } from "@dardcor-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@dardcor/ProjectCopy") {}
