...
import type { EffectDrizzleSqlite } from "@dardcor-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@dardcor/ProjectDirectories") {}
