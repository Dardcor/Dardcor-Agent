...
import type { Data, Definition, Payload } from "@dardcor-ai/schema/event"
...
import { Durable } from "@dardcor-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@dardcor-ai/schema/event").ID
export type { Data, Definition, Payload } from "@dardcor-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@dardcor/Event") {}
