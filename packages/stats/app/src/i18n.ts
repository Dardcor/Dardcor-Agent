...
const en = {
  "app.title": "AI Model Usage Rankings | dardcor Data",
  "app.description":
  ...
  "app.unfurlAlt": "dardcor Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star dardcor on GitHub",
  "header.github": "GitHub",
  "header.trydardcor": "Try dardcor",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | dardcor Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Reading model availability and recent dardcor usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in dardcor",
  ...
  "lab.shareOfUsage": "{{share}} of recent dardcor usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | dardcor Data",
  "model.description":
