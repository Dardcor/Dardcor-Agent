import dardcorWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/dardcor",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "dardcor:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://dardcor-code.vercel.app//">
            <strong>{i18n.t("header.trydardcor")}</strong>
          </a>
          <button
...
function dardcorMark() {
  return (
    <svg data-slot="dardcor-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://dardcor-code.vercel.app//legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://dardcor-code.vercel.app//legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@dardcor.ai", label: i18n.t("footer.contact") },
    { href: "https://dardcor-code.vercel.app//discord", label: i18n.t("footer.community") },
    { href: "https://x.com/dardcor", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://dardcor-code.vercel.app/" aria-label={i18n.t("footer.homeAria")}>
          <dardcorMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={dardcorWordmarkDark} alt="dardcor" />
          <button
