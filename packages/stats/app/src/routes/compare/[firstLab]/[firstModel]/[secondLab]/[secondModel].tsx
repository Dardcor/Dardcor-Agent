...
import { getStatsModelComparisonData, type StatsModelComparisonEntry } from "@dardcor-ai/stats-core/domain/home"
import { runtime } from "@dardcor-ai/stats-core/runtime"
...
const compareFallbackUrl = "https://stats.dardcor.ai"
...
export default function ModelComparePair() {
  ...
  const description = createMemo(
    () =>
      `Compare ${models()[0].name} and ${models()[1].name} by usage, rank, context window, output limit, cache ratio, and cost across dardcor data.`,
  )
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="dardcor" />
