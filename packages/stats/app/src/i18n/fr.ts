export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | dardcor Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logo textuel dardcor Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à dardcor sur GitHub",
  "header.github": "GitHub",
  "header.trydardcor": "Essayer dardcor",
  ...
  "footer.homeAria": "Accueil dardcor",
  ...
  "modal.title": "Newsletter dardcor",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | dardcor Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'dardcor.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans dardcor",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'dardcor",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens dardcor sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | dardcor Data",
  "model.description":
