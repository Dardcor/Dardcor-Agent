export const dict = {
  "app.title": "KI-Modellnutzungs-Rankings | dardcor Data",
  "app.description":
  ...
  "app.unfurlAlt": "dardcor Data-Wortmarke auf dunklem gemustertem Hintergrund",
  ...
  "header.githubAria": "dardcor auf GitHub mit Stern markieren",
  "header.github": "GitHub",
  "header.trydardcor": "dardcor ausprobieren",
  ...
  "footer.homeAria": "dardcor-Startseite",
  ...
  "modal.title": "dardcor-Newsletter",
  ...
  "lab.title": "{{lab}} KI-Modellnutzung und Rankings | dardcor Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Modellverfügbarkeit und aktuelle dardcor-Nutzung werden gelesen.",
  "lab.notFound": "Keine Modelle passten zu diesem Lab.",
  "lab.heroPrefix": "Erkunde {{count}} {{lab}}-Modelle, die in dardcor verwendet werden",
  ...
  "lab.shareOfUsage": "{{share}} der aktuellen dardcor-Nutzung",
  "lab.usageTitle": "{{lab}}-Tokennutzung",
  "lab.usageDescription": "Tägliches dardcor-Tokenvolumen der letzten zwei Monate.",
  ...
  "lab.usage": "Nutzung",
  "lab.share": "Anteil",
  "model.title": "{{model}} Nutzung, Kosten und Rang | dardcor Data",
  "model.description":
