export const dict = {
  "app.title": "Рейтинги використання моделей ШІ | dardcor Data",
  "app.description":
  ...
  "app.unfurlAlt": "Словесний знак dardcor Data на темному візерунковому тлі",
  ...
  "header.githubAria": "Поставити зірку dardcor на GitHub",
  "header.github": "GitHub",
  "header.trydardcor": "Спробувати dardcor",
  ...
  "footer.homeAria": "Головна dardcor",
  ...
  "lab.title": "Використання та рейтинги моделей ШІ {{lab}} | dardcor Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Читаємо доступність моделей і нещодавнє використання dardcor.",
  "lab.notFound": "Жодна модель не відповідала цій лабораторії.",
  "lab.heroPrefix": "Досліджуйте {{count}} моделей {{lab}}, що використовуються в dardcor",
  ...
  "lab.shareOfUsage": "{{share}} нещодавнього використання dardcor",
  "lab.usageTitle": "Використання токенів {{lab}}",
  "lab.usageDescription": "Щоденний обсяг токенів dardcor за останні два місяці.",
  ...
  "lab.share": "Частка",
  "model.title": "Використання, вартість і ранг {{model}} | dardcor Data",
  "model.description":
