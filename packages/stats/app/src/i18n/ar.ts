export const dict = {
  "app.title": "ترتيب استخدام نماذج الذكاء الاصطناعي | dardcor Data",
  "app.description":
  ...
  "app.unfurlAlt": "شعار dardcor Data على خلفية داكنة مزخرفة",
  ...
  "header.githubAria": "ضع نجمة لـ dardcor على GitHub",
  "header.github": "GitHub",
  "header.trydardcor": "جرّب dardcor",
  ...
  "footer.homeAria": "صفحة dardcor الرئيسية",
  ...
  "modal.title": "نشرة dardcor الإخبارية",
  ...
  "lab.title": "استخدام وترتيب نماذج {{lab}} للذكاء الاصطناعي | dardcor Data",
  "lab.description":
  ...
  "lab.loadingDescription": "قراءة توفر النماذج واستخدام dardcor الأخير.",
  "lab.notFound": "لم تطابق أي نماذج هذا المختبر.",
  "lab.heroPrefix": "استكشف {{count}} من نماذج {{lab}} المستخدمة في dardcor",
  ...
  "lab.shareOfUsage": "{{share}} من استخدام dardcor الأخير",
  "lab.usageTitle": "استخدام رموز {{lab}}",
  "lab.usageDescription": "حجم رموز dardcor اليومي خلال الشهرين الماضيين.",
  ...
  "lab.usage": "الاستخدام",
  "lab.share": "الحصة",
  "model.title": "استخدام {{model}} وتكلفته وترتيبه | dardcor Data",
  "model.description":
