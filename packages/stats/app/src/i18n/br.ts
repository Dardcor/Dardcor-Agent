export const dict = {
  "app.title": "Ranking de uso de modelos de IA | dardcor Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo do dardcor Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao dardcor no GitHub",
  "header.github": "GitHub",
  "header.trydardcor": "Experimente o dardcor",
  ...
  "footer.homeAria": "Início do dardcor",
  ...
  "modal.title": "Newsletter do dardcor",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | dardcor Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do dardcor.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no dardcor",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do dardcor",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do dardcor nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | dardcor Data",
  "model.description":
