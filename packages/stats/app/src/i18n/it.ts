export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | dardcor Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo dardcor Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a dardcor su GitHub",
  "header.github": "GitHub",
  "header.trydardcor": "Prova dardcor",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | dardcor Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di dardcor.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in dardcor",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di dardcor",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token dardcor negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | dardcor Data",
  "model.description":
