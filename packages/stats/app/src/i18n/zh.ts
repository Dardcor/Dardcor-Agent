...
export const dict = {
  ...
  "header.githubAria": "在 GitHub 上为 dardcor 加星",
  "header.github": "GitHub",
  "header.trydardcor": "试用 dardcor",
  "header.openNav": "打开导航",
  ...
  "lab.title": "{{lab}} AI 模型使用量与排名 | dardcor 数据",
  "lab.description":
    "比较在 opencode Go 中使用的 {{lab}} 模型，包括 token 用量、模型排名、上下文窗口、发布日期、成本和模型专属数据。",
  "lab.loadingTitle": "模型实验室",
  "lab.loadingDescription": "正在读取模型可用性和近期 dardcor 使用情况。",
  "lab.notFound": "没有匹配此实验室的模型。",
  "lab.heroPrefix": "探索 dardcor 中使用的 {{count}} 个 {{lab}} 模型",
  ...
  "lab.shareOfUsage": "占近期 dardcor 使用量的 {{share}}",
  "lab.usageTitle": "{{lab}} token 用量",
  "lab.usageDescription": "过去两个月的每日 dardcor token 用量。",
  ...
  "lab.usage": "用量",
  "lab.share": "份额",
  "model.title": "{{model}} 使用量、成本与排名 | dardcor 数据",
  "model.description":
