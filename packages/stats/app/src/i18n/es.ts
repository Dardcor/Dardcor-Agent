export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | dardcor Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo textual de dardcor Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a dardcor en GitHub",
  "header.github": "GitHub",
  "header.trydardcor": "Probar dardcor",
  ...
  "footer.homeAria": "Inicio de dardcor",
  ...
  "modal.title": "Boletín de dardcor",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | dardcor Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de dardcor.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en dardcor",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de dardcor",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de dardcor durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | dardcor Data",
  "model.description":
