export const dict = {
  "app.title": "Rankingi użycia modeli AI | dardcor Data",
  "app.description":
  ...
  "app.unfurlAlt": "Znak słowny dardcor Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę dardcor na GitHub",
  "header.github": "GitHub",
  "header.trydardcor": "Wypróbuj dardcor",
  ...
  "footer.homeAria": "Strona główna dardcor",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | dardcor Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia dardcor.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w dardcor",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia dardcor",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów dardcor z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | dardcor Data",
  "model.description":
