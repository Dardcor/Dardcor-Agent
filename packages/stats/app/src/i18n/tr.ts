export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | dardcor Data",
  "app.description":
  ...
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde dardcor Data logosu",
  ...
  "header.githubAria": "GitHub'da dardcor'a yıldız ver",
  "header.github": "GitHub",
  "header.trydardcor": "dardcor'u dene",
  ...
  "footer.homeAria": "dardcor ana sayfası",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | dardcor Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Model kullanılabilirliği ve son dardcor kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "dardcor'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son dardcor kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük dardcor token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | dardcor Data",
  "model.description":
