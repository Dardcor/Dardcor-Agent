export const dict = {
  "app.title": "Ranglister for brug af AI-modeller | dardcor Data",
  "app.description":
  ...
  "app.unfurlAlt": "dardcor Data-ordmærke på en mørk mønstret baggrund",
  ...
  "header.githubAria": "Giv dardcor en stjerne på GitHub",
  "header.github": "GitHub",
  "header.trydardcor": "Prøv dardcor",
  ...
  "footer.homeAria": "dardcor-forside",
  ...
  "modal.title": "dardcor-nyhedsbrev",
  ...
  "lab.title": "{{lab}} AI-modelbrug og ranglister | dardcor Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Læser modeltilgængelighed og seneste dardcor-brug.",
  "lab.notFound": "Ingen modeller matchede dette lab.",
  "lab.heroPrefix": "Udforsk {{count}} {{lab}}-modeller brugt i dardcor",
  ...
  "lab.shareOfUsage": "{{share}} af den seneste dardcor-brug",
  "lab.usageTitle": "{{lab}}-tokenbrug",
  "lab.usageDescription": "Daglig dardcor-tokenvolumen over de sidste to måneder.",
  ...
  "lab.usage": "Brug",
  "lab.share": "Andel",
  "model.title": "{{model}} brug, omkostning og rang | dardcor Data",
  "model.description":
