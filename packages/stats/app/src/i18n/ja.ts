...
export const dict = {
  ...
  "header.githubAria": "GitHubでdardcorにスターを付ける",
  "header.github": "GitHub",
  "header.trydardcor": "dardcorを試す",
  ...
  "lab.title": "{{lab}} AIモデル使用量とランキング | dardcorデータ",
  "lab.description":
    "opencode Goで使用されている{{lab}}モデルを、トークン使用量、モデルランキング、コンテキストウィンドウ、リリース日、コスト、モデル別データで比較できます。",
  "lab.loadingTitle": "モデルラボ",
  "lab.loadingDescription": "モデルの利用可否と最近のdardcor使用状況を読み込んでいます。",
  "lab.notFound": "このラボに一致するモデルはありません。",
  "lab.heroPrefix": "dardcorで使用されている{{count}}件の{{lab}}モデルを確認",
  ...
  "lab.shareOfUsage": "最近のdardcor使用量の{{share}}",
  "lab.usageTitle": "{{lab}}のトークン使用量",
  "lab.usageDescription": "過去2か月の日次dardcorトークン量。",
  ...
  "lab.usage": "使用量",
  "lab.share": "シェア",
  "model.title": "{{model}}の使用量、コスト、ランク | dardcorデータ",
  "model.description":
