export const dict = {
  "app.title": "Rangeringer for bruk av AI-modeller | dardcor Data",
  "app.description":
  ...
  "app.unfurlAlt": "dardcor Data-ordmerke på en mørk mønstret bakgrunn",
  ...
  "header.githubAria": "Gi dardcor en stjerne på GitHub",
  ...
  "modal.title": "dardcor-nyhetsbrev",
  ...
  "lab.title": "{{lab}} AI-modellbruk og rangeringer | dardcor Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Leser modelltilgjengelighet og nylig dardcor-bruk.",
  "lab.notFound": "Ingen modeller matchet dette laben.",
  "lab.heroPrefix": "Utforsk {{count}} {{lab}}-modeller brukt i dardcor",
  ...
  "lab.shareOfUsage": "{{share}} av nylig dardcor-bruk",
  "lab.usageTitle": "{{lab}} tokenbruk",
  "lab.usageDescription": "Daglig dardcor-tokenvolum over de siste to månedene.",
  ...
  "lab.usage": "Bruk",
  "lab.share": "Andel",
  "model.title": "{{model}} bruk, kostnad og rangering | dardcor Data",
  "model.description":
