...
import defaultSoundPath from "@dardcor-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@dardcor-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@dardcor-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@dardcor-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@dardcor-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@dardcor-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "dardcor"
const DEFAULT_PACK_ID = "dardcor.default"
