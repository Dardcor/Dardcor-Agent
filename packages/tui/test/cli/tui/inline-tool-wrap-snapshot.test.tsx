...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "dardcor.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/dardcor/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/dardcor (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/dardcor/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/dardcor/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const dardcor_DB|dardcor_DB|dardcor_DEV|Global\\.Path\\.data|data =" in packages/dardcor/src (115 matches)',
  },
] as const
