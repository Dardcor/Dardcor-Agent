...
- Effect plugins import `@dardcor-ai/plugin/v2/effect`, not `@dardcor-ai/core`.
- Public domain values use generated `@dardcor-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@dardcor-ai/plugin/v2/effect`.
