...
class Database extends Context.Service<Database, DatabaseShape>()("@dardcor/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@dardcor/example/UserStore") {
