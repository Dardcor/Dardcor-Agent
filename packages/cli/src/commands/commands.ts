...
declare const dardcor_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof dardcor_CLI_NAME === "string" ? dardcor_CLI_NAME : "dardcor", {
  description: "dardcor 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
