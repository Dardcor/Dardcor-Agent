...
const tableBucketName = `dardcor-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `dardcor-${$app.stage}-lake-ingest`,
    destination: "iceberg",
