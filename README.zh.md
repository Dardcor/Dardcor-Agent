...
brew install anomalyco/tap/dardcor # macOS 和 Linux（推荐，始终保持最新）
brew install dardcor              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S dardcor            # Arch Linux (Stable)
paru -S dardcor-bin               # Arch Linux (Latest from AUR)
mise use -g dardcor               # 任意系统
nix run nixpkgs#dardcor           # 或用 github:anomalyco/dardcor 获取最新 dev 分支
```
...
dardcor 也提供桌面版应用。可直接从 [发布页 (releases page)](https://dardcor-code.vercel.app/) 或 [dardcor.ai/download](https://dardcor-code.vercel.app/) 下载。
...
1. `$dardcor_INSTALL_DIR` - 自定义安装目录
2. `$XDG_BIN_DIR` - 符合 XDG 基础目录规范的路径
3. `$HOME/bin` - 如果存在或可创建的用户二进制目录
4. `$HOME/.dardcor/bin` - 默认备用路径
...
dardcor 内置两种 Agent，可用 `Tab` 键快速切换：
...
了解更多 [Agents](https://dardcor-code.vercel.app/) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://dardcor-code.vercel.app/)。
...
如果你在项目名中使用了 “dardcor”（如 “dardcor-dashboard” 或 “dardcor-mobile”），请在 README 里注明该项目不是 dardcor 团队官方开发，且不存在隶属关系。

---

**加入我们的社区** [飞书](https://dardcor-code.vercel.app/) | [X.com](https://dardcor-code.vercel.app/)
